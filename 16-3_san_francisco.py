# -*- coding: utf-8 -*-
"""
Created on Wed Aug  3 09:07:40 2022
...
san_fran_file = 'data/san_francisco_2018_daily_weather_simple.csv'
...
# get san fran data from file
dates, highs, lows = [], [], []
get_weather_data(san_fran_file, dates, highs, lows, 2, 6, 7)

# plot san fran
ax.plot(dates, highs, c='green', alpha=0.35)
ax.plot(dates, lows, c='green', alpha=0.25)
ax.fill_between(dates, highs, lows, facecolor='green', alpha=0.15)
